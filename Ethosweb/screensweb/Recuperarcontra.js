      ...
      >
        <ScrollView contentContainerStyle={styles.scrollContainer}>
          <View style={styles.formContainer}>
            ...
            <Text style={styles.subTitle}>Ingresa tu correo electrónico para recibir instrucciones para recuperar tu cuenta.</Text>
            <TextInput
              style={styles.input}
            ...
            <TouchableOpacity>
              <Text style={styles.registerLink}>¿Aún no tienes cuenta? Regístrate</Text>
            </TouchableOpacity>
          </View>
        </ScrollView>
      </ImageBackground>
